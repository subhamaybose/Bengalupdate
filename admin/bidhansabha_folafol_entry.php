...
if(!isset($_POST['update'])){
			...
			$sql=mysql_query("update `bidhansabha_result` set 
			`state`='".$_POST['state']."',
			`district`='".$_POST['district']."',
			`kendro`='".$_POST['kendro']."',
			`ca_dol_1`='".$_POST['p_dol1']."',
			...
			echo "<script>window.location.href='bidhansabha_folafol_list.php';</script>";
...
<div id="page-heading"><h1>Add Edit Bidhansabha Result</h1></div>
...
<tr>
	...
	<tr>
		...
		<td valign="top">
			...
			<input type="button" value="" class="form-back"  onClick="window.location.href='bidhansabha_folafol_list.php'" />
		</td>
		<td></td>
	</tr>
             </table>
