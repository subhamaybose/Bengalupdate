...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>State Wise Assembly Constituency Listing</h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
        ...
        <div id="content-table-inner">
			...
			<div id="table-content">
				...
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="green-left"> <?php if(isset($_REQUEST['msg'])){if($_REQUEST['msg']=='1'){ echo "Deleted Successfully";}else if($_REQUEST['msg']=='2'){ echo "Status Changed Sussessfully";}else if($_REQUEST['msg']=='3'){  echo"Added Successfully";}else if($_REQUEST['msg']=='4'){  echo"Added to Archive Successfully";}}?> <a href="bidhansabha_kendro_entry.php">Add new Constituency.</a></td>
                ...
                <?php $sql=mysql_query("SELECT bidhansabha_constituency.id AS ids, bidhansabha_constituency.status AS stat, rajjo.rajjo AS state, district.district as dist, bidhansabha_constituency.constituency AS const FROM bidhansabha_constituency LEFT JOIN rajjo ON bidhansabha_constituency.state=rajjo.id LEFT JOIN district ON bidhansabha_constituency.district=district.id order by bidhansabha_constituency.id desc");
				...
				<tr class="alternate-row">					
                    ...
                    <td><a href="bidhansabha_kendro_acttion.php?act=status&id=<?php echo $sqlf->ids;?>&st=<?php echo $sqlf->stat;?>"><?php echo ($sqlf->stat=='0')?'Show':'Hide';?></a></td>

					<td class="options-width">
					<a href="bidhansabha_kendro_entry.php?id=<?php echo $sqlf->ids;?>" onclick="return confirm('Are you sure you want to edit this item?');" title="Edit" class="icon-1 info-tooltip"></a>
