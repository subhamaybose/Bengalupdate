...
if(!isset($_POST['update'])){
			...
			$sql=mysql_query("update `by_election_loksabha_result` set 
			`state`='".$_POST['state']."',
			`kendro`='".$_POST['kendro']."',
			`ca_dol_1`='".$_POST['p_dol1']."',
			`vo_dol_1`='".$_POST['v_dol1']."',
			...
			echo "<script>window.location.href='by_election_loksabha_folafol_list.php';</script>";
...
<div id="page-heading"><h1>Add Edit By Election Loksabha Result</h1></div>
...
<tr>
	...
	<tr>
		...
		<td valign="top">
			...
			<input type="button" value="" class="form-back"  onClick="window.location.href='by_election_loksabha_folafol_list.php'" />
		</td>
		<td></td>
	</tr>
             </table>
