...
if(!isset($_POST['update'])){
			$sql=mysql_query("insert into `page_manager` set 
			`name`='".$_POST['name']."',
			`title`='".$_POST['title']."',
			...
			$sql=mysql_query("update `page_manager` set 
			`name`='".$_POST['name']."',
			`title`='".$_POST['title']."',
			`keyword`='".$_POST['keyword']."',
			`description`='".$_POST['description']."',
			...
			echo "<script>window.location.href='pagelist.php';</script>";
...
<div id="page-heading"><h1>Add Edit Page </h1></div>
...
<tr>
	...
	<td>
		...
		<!--  start step-holder -->
		<div id="step-holder">			
			<div class="step-dark-left"><a href="">SEO Page</a></div>
			<div class="clear"></div>
		</div>
		<!--  end step-holder -->
        ...
        <?php if(isset($_REQUEST['id'])&&$_REQUEST['id']!=''){
			$sqll= mysql_query("select * from `page_manager` where `id`='".$_REQUEST['id']."' ");
        ...
        <tr>
			<th valign="top">Page Titile:</th>
			<td><textarea rows="" cols="" name="title" class="form-textarea"><?php echo $sqllf->title;?></textarea></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Page Keyword:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="keyword"><?php echo $sqllf->keyword;?></textarea></td>
			<td></td>
		</tr>
        		<tr>
			<th valign="top">Page Description:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="description"><?php echo $sqllf->keyword;?></textarea></td>
			<td></td>
		</tr>
	...
	<tr>
		...
		<td valign="top">
			...
			<input type="button" value="" class="form-back"  onClick="window.location.href='pagelist.php'" />
		</td>
		<td></td>
	</tr>
	</table>
		...
		<tr>
			<th valign="top">Page Keyword:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="keyword"></textarea></td>
			<td></td>
		</tr>
        		<tr>
			<th valign="top">Page Description:</th>
