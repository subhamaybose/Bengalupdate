...
if(!isset($_POST['update'])){
			...
			$sql=mysql_query("insert into `panchayat` set 
			`id`='',
			`status`='0',
			`state`='".$_POST['state']."',
			...
			`zseats`='".$_POST['zseats']."',
			`ps_seats`='".$_POST['psseats']."',
			`gpseats`='".$_POST['gpseats']."',
			`date`='".date("Y-m-d",time())."'",$conn);
			
			$sql1=mysql_query("insert into `panchayat` set 
			`id`='',
			`status`='0',
			`state`='".$_POST['state']."',
			`district`='".$_POST['district']."',
			...
			$sql=mysql_query("update `panchayat` set 
			`state`='".$_POST['state']."',
			`district`='".$_POST['district']."',
			`panchayat`='".$_POST['panchayat_name']."',
			`zseats`='".$_POST['zseats']."',
			...
			echo "<script>window.location.href='panchayat_list.php';</script>";
...
<div id="page-heading"><h1>Add Edit Panchayat</h1></div>
...
<tr>
	...
	<td>
		...
		<!--  start step-holder -->
		<div id="step-holder">			
			<div class="step-dark-left"><a href="">Panchayat Entry Page</a></div>
			<div class="clear"></div>
		</div>
		<!--  end step-holder -->
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="panchayat_name" id="panchayat_name" value="<?php echo $sqllf->panchayat;?>"/></td>
			<td></td>
		</tr>
		<tr>
            <th valign="top">জেলা পরিসদ  আসন সংখ্যা:</th>
            <td><input type="text" class="inp-form" name="zseats" id="zseats" value="<?php echo $sqllf->zseats;?>"/></td>
            <td></td>
		</tr>
		<tr>
            <th valign="top">মোট পঞ্চায়েত সমিতি:</th>
            <td><input type="text" class="inp-form" name="psseats" id="psseats" value="<?php echo $sqllf->ps_seats;?>"/></td>
            <td></td>
		</tr>
		<tr>
            <th valign="top">মোট গ্রাম পঞ্চায়েত:</th>
            <td><input type="text" class="inp-form" name="gpseats" id="gpseats" value="<?php echo $sqllf->gpseats;?>"/></td>
            <td></td>
		</tr>
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			...
			<input type="button" value="" class="form-back"  onClick="window.location.href='panchayat_list.php'" />
		</td>
		<td></td>
	</tr>
             </table>
    ...
    <form action="<?php $_SERVER['PHP_SELF']?>" method="post"  enctype="multipart/form-data">
		...
		<tr>
			<th valign="top">জেলা পরিসদ-এর  নাম :</th>
			<td><input type="text" class="inp-form" name="panchayat_name" id="panchayat_name" value=""/></td>
			<td></td>
		</tr>
		<tr>
            <th valign="top">জেলা পরিসদ  আসন সংখ্যা:</th>
            <td><input type="text" class="inp-form" name="zseats" id="zseats" value=""/></td>
            <td></td>
		</tr>
		<tr>
            <th valign="top">মোট পঞ্চায়েত সমিতি:</th>
            <td><input type="text" class="inp-form" name="psseats" id="psseats" value=""/></td>
            <td></td>
		</tr>
		<tr>
            <th valign="top">মোট গ্রাম পঞ্চায়েত:</th>
            <td><input type="text" class="inp-form" name="gpseats" id="gpseats" value=""/></td>
            <td></td>
		</tr>
	<tr>
		<th>&nbsp;</th>
