        ...
        <div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<td class="green-left"> <?php if(isset($_REQUEST['msg'])){if($_REQUEST['msg']=='1'){ echo "Deleted Successfully";}else if($_REQUEST['msg']=='2'){ echo "Status Changed Sussessfully";}else if($_REQUEST['msg']=='3'){  echo"Added Successfully";}}?> <a href="rajjomng.php">Add new Rajjo Post.</a></td>
				...
				<tr>					
					...
					<td colspan="7" align="center"> <strong>No Rajjo post Added</strong></td>
				...
				<tr class="alternate-row">					
                    ...
                    <td><?php echo $sqlf->dol;?></td>
                    <td><?php echo $sqlf->_2009;?></td>
                    <td><?php echo $sqlf->_2014;?></td>

                    <td><?php echo date('F d, Y',$sqlf->date);?></td>

					<td class="options-width">

					<a href="rajjomng.php?id=<?php echo $sqlf->id;?>" title="Edit" class="icon-1 info-tooltip"></a>

					<a href="rajjoacttion.php?act=delete&id=<?php echo $sqlf->id;?>" title="Delete" class="icon-2 info-tooltip"></a>
