		...
		<div class="span8">
			<div class="insidecont">
				...
				<div class="cont">
					...
					<p style="margin:15px 0; text-align:center; color:#393;" align="center">সংবাদটি </p><!--৩৬৩--> <div id="counter" style="margin:15px 0; text-align:center; color:#393;" align="center"></div>  <p style="margin:15px 0; text-align:center; color:#393;" align="center">বার পঠিত</p>
