	...
	<div class="span8">
		<div class="insidecont">
			...
			<div class="heading-panel">
				...
				<div class="panelR"> <a href="knowledge_science.php?dt=<?php echo $_REQUEST['dt'];?>">আরও খবর দেখুন</a> </div>
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
			...
			<div class="heading-panel">
				...
				<div class="panelR"> <a href="green_earth.php?dt=<?php echo $_REQUEST['dt'];?>">আরও খবর দেখুন</a> </div>
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
			<ul class="sectionBlist2">
