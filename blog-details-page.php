...
function addHit(){
	mysql_query("INSERT INTO blog_hit_count ( pge_name, views) VALUES ( 'id=".$_GET['id']."', 3500) ON DUPLICATE KEY UPDATE views=views+1");
}
addHit();
function getHit(){
	$hits = mysql_query("SELECT * FROM `blog_hit_count` WHERE `pge_name`='id=".$_GET['id']."'");
...
<div class="row">
    ...
    <div class="clear"></div>
    <?php $sql=mysql_query("select * from `blog` where `status`='0' and `id`='".$_GET['id']."' ");
    ...
    <div class="span8">
        <div class="insidecont">
            ...
            <div class="clear"></div>
            <div class="clear"></div>
            <div class="thumb"><img src="images/uploaded/blog/<?php echo $ff->image;?>" alt="<?php echo $ff->title;?>" /></div>
            <div class="cont">
                <?php echo $ff->text;?>
				<p style="margin:15px 0; text-align:center; color:#393;" align="center">সংবাদটি <?php echo getHit();?> বার পঠিত</p>
                <div class="time">
                    <i class="fa fa-clock-o"></i><?php echo date('l jS F Y',strtotime($ff->date));?>
                </div>
                <div class="writer">
                ...
                <div class="comments_plug">
                    ...
                    <div class="fb-comments" data-href="blog-details-page.php?id=<?php echo $ff->id;?>l" data-width="590" data-numposts="10"></div>
                </div>
                <div class="clear"></div>
