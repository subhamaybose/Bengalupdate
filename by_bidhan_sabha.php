    ...
    <div class="clear"></div>
		...
		<div class="span12">
			<div class="election">
     			...
     			<thead>
             		<tr>
						...
						if(mysql_num_rows($sql)> 0){
							while($sqlf=mysql_fetch_object($sql) ){
						?>
                            <h1>উপনির্বাচন -বিধানসভার ফলাফল (<span><?php echo $sqlf->bidhansabha;?></span> টি আসন) <span><?php echo $_REQUEST['yr'];?></span></h1>
						<?php }}?>
              ...
              <tbody>
                  <?php $sql=mysql_query("SELECT by_election_bidhansabha_result.id, bidhansabha_constituency.constituency, by_election_bidhansabha_result.ca_dol_1, by_election_bidhansabha_result.vo_dol_1, by_election_bidhansabha_result.ca_dol_2, by_election_bidhansabha_result.vo_dol_2, by_election_bidhansabha_result.ca_dol_3, by_election_bidhansabha_result.vo_dol_3, by_election_bidhansabha_result.ca_dol_4, by_election_bidhansabha_result.vo_dol_4, by_election_bidhansabha_result.ca_dol_5, by_election_bidhansabha_result.vo_dol_5, by_election_bidhansabha_result.status, by_election_bidhansabha_result.round, by_election_bidhansabha_result.result, by_election_bidhansabha_result.difference FROM `by_election_bidhansabha_result` LEFT JOIN bidhansabha_constituency ON by_election_bidhansabha_result.kendro=bidhansabha_constituency.id WHERE by_election_bidhansabha_result.district='".$_REQUEST['district']."' AND by_election_bidhansabha_result.date='".$_REQUEST['yr']."' AND by_election_bidhansabha_result.status='0' ");
					if(mysql_num_rows($sql)==0){
					?>
					<tr>					
