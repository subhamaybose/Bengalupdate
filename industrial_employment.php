	...
	<div class="span8">
		<div class="insidecont">
			...
			<div class="heading-panel">
				...
				<div class="panelR"> <a href="fields.php">আরও খবর দেখুন</a> </div>
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
			...
			<div class="heading-panel">
				...
				<div class="panelR"> <a href="industry_world.php">আরও খবর দেখুন</a> </div>
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
			<ul class="sectionBlist2">
			...
			<div class="heading-panel">
				...
				<div class="panelR"> <a href="sarojgari.php">আরও খবর দেখুন</a> </div>
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
			<ul class="sectionBlist2">
