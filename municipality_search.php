...
<div class="row">
	...
	<div class="clear"></div>
		...
		<div class="span12">
			<div class="election">
				<form action="municipality_search.php" method="post" class="election-form">
					<h1>Search</h1>
					<!--<div class="">
					...
					<div class="">
						<select name="e_municipality" id="e_municipality">
		...
		if(isset($_POST['submit'])){
			...
			$municipality=$_POST['e_municipality'];
			$url ="puro_sabha.php?state=".$state."&yr=".$yr."&district=".$district."&municipality=".$municipality;
			header('location: '.$url);
		}
		?>
		<!--==============================================Election form================================================= -->
