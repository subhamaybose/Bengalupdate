...
<div class="row">
	...
	<div class="insidecont">
		...
		<div class="clear"></div>
		<?php $sql=mysql_query("select * from `video` where `status`='0' and `cat`='rajnity' and `id`='".$_REQUEST['vid']."'");
		...
		<div class="Videodetailspage">
			...
			<div class="logoicon"><img src="http://bengalupdate.in/images/logo.png" /></div>
		</div>
		<div class="clear"></div>
	</div>
	<div class="clear"></div>
