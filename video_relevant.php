...
<div class="row">
	...
	<div class="sectionD">
		<ul class="Videolist">
			<?php $sql=mysql_query("select * from `video` where `status`='0' and `cat`='prasongik' order by `id` desc");
			...
			<li>
				...
				<div class="hoverlay-box"> <a class="btn" href="video_relevant_details-page.php?vid=<?php echo $ff->id;?>">বিস্তারিত পড়ুন</a> </div>
			</li>
		    <?php } ?>
		</ul>
		<div class="clear"></div>
